...
export default function ProjectCard({ project, index }: { project: Project; index: number }) {
  ...
  return (
    <div
      ...
      data-cursor-hover
      className="glass gpu-layer group relative overflow-hidden rounded-3xl p-8 transform-3d sm:p-10"
    >
      <div
        data-layer-2
      ...
      <div data-layer-1 className="gpu-layer relative transform-[translateZ(30px)]">
        ...
        <div className="mt-7 grid gap-4 border-t border-line pt-6 sm:grid-cols-2">
          <div>
            <p className="mb-1 text-[11px] uppercase tracking-widest text-red-bright/70">Challenge</p>
            <p className="text-sm leading-relaxed text-fg-dim">{project.challenges}</p>
          </div>
          <div>
            <p className="mb-1 text-[11px] uppercase tracking-widest text-red-bright/70">Result</p>
